...
# put osagent in /usr/local/bin
cp "$INSTALL_DIR/osagent" /usr/local/bin/osagent
chmod +x /usr/local/bin/osagent

echo "Installation complete. Service started. Try: osagent \"show os version and kernel\""
